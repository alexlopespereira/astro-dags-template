...
@dag(
    dag_id='bitcoin_monthly_prices_to_postgres',
...
def crypto_etl_dag():
    ...
    def load_to_postgres(rows):
        ...
        """
        pg_hook.insert_rows(table='btc_prices', rows=rows, target_fields=['timestamp', 'price_usd', 'market_cap_usd', 'total_volume_usd'])
